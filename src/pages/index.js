 ...
 */}
          ...
          <Link to="/symbionts" state={{ modal: true }}>
...
export const Head = () => (
  <Seo
    title="Accueil"
    description="Indie / Post-hardcore / 90s Emo entre Paris et Brest - Nouvel album Symbionts 17/10/25 - Nouveau single Tides OUT!"
  />
)
